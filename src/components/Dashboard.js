  ...
  return (
    <section id="dashboard">
      ...
      <div id="imageCarousel">
        ...
        <div>
          <img
            src={`${process.env.PUBLIC_URL}/images/1.jpg`} // Reference image correctly from public
        ...
        <div>
          <img
            src={`${process.env.PUBLIC_URL}/images/2.jpg`} // Reference image correctly from public
        ...
        <div>
          <img
            src={`${process.env.PUBLIC_URL}/images/3.jpg`} // Reference image correctly from public
